...
<script setup>
  ...
  watch(colorMode, () => {
    console.log("the mode", colorMode.preference);
  });
    ...
    <ClientOnly>
      ...
      >
        ...
        <HeadlessListboxOptions
          class="p-1 absolute z-50 origin-top-right top-full right-0 outline-none bg-white rounded-lg ring-1 ring-gray-900/10 shadow-lg overflow-hidden w-36 py-1 text-sm text-gray-700 font-semibold dark:bg-primary-dark dark:ring-0 dark:highlight-white/5 dark:text-gray-300"
        >
