    ...
    >
      ...
      <div class="flex-1 flex relative">
        ...
        <input
          ...
          step="any"
          :id="id"
          class="focus:ring-primary px-3 focus:border-primary hover:border-primary h-10 border-gray-300 border-1 outline-none ring-0 border-none bg-secondary-4 dark:bg-minab-dark-background dark:text-secondary-navbar focus:ring-1 block w-full text-secondary focus:outline-none text-base rounded-md"
          :class="[
            errorMessage
        ...
        <div
          ...
          class="absolute inset-y-0 right-0 flex items-center pr-3 hover:cursor-pointer"
          :class="props.iconTraillingClass"
        >
          <Icon
            class="text-gray-500"
            :name="props.trailingIcon"
